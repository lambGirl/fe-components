...
export default collect(async nextProps => {
  ...
  const locale = utils.isZhCN(pathname) ? 'zh-CN' : 'zh-CN';

  console.log('pageData :', typeof pageData === 'function');
  ...
  if (demosFetcher) {
    ...
    console.log('localizedPageData, demos :', localizedPageData, demos);
